...
== Clasificación dinámica de nodos (_NEW en el elemento 12.3.1!_)

La clasificación dinámica de nodos es una nueva característica de Element 12.3.1, que le permite aprovechar 24 CPU compatibles por plataforma eSDS en lugar del modelo actual de una única CPU por plataforma.
