...
* *Capacidad para definir un número máximo de instantáneas que retener*: Element 12.3 introduce mejoras en la función de retención de instantáneas. Se han modificado las siguientes API para admitir esta mejora (consulte https://docs.netapp.com/us-en/element-software/api/index.html["Documentación de la API de Element"^] para obtener detalles sobre cada método):
+
** `CreateVolume`
** `ModifyVolume`
** `CreateSnapshot`
